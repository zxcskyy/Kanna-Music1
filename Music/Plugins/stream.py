...
async def vplay(c: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/vieenasupport"),
                InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/kyyproject"),
            ]
        ]
    )
...
✨ Powered by: [Vieena Robot](t.me/vieenarobot)
""",
...
""",
    ...
    try:
        ...
        try:
            ...
            return await message.reply_text(
                f"❌ **@assistantvieena Assistant gagal bergabung**\n\n**Alasan**: `{e}`"
            )
...
» `/vplay duka`""",
            ...
            try:
                ...
                while j < 5:
                    ...
                    toxxt += f"💡 [More Information](https://t.me/vieenarobot?start=info_{data[j]['id']})\n"
                    toxxt += f"⚡ **Powered by:** __VIEENA ROBOT__\n\n"
                    j += 1
